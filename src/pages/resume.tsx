...
import ResumeShot from "public/assets/Tubagus_Assad_Resume.jpg";

const ResumePdf = () => {
	const resumePdfLink = "/assets/Tubagus_Assad_Resume.pdf";
	return (
		<>
...
const Resume = () => {
	return (
		<>
			<Head>
				<title>Tubagus Ass'ad | Resume</title>
				<meta
					name="description"
			...
			<div className="max-w-[940px] mx-auto p-2 pt-[120px]">
				...
				<div className="bg-[#d0d4d6] my-4 p-4 w-full flex justify-between items-center">
					<h2 className="text-center">Tubagus Ass'ad</h2>
					<div className="flex">
						<a
						...
						<a href="https://github.com/si-acus/" target="_blank" rel="noreferrer">
